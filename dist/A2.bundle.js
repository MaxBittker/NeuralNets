...
/***/ function(module, exports, __webpack_require__) {
	...
	var trainingData = __webpack_require__(2);
	...
	perceptron.prototype = {
	    ...
	    learn: function learn(method, x, y, d) {
	        if (method === "Simple Feedback") this.learnSimpleFeedback(x, y, d);else this.learnErrorCorrection(x, y, d);
	    },
	    learnSimpleFeedback: function learnSimpleFeedback(x, y, d) {
	        var _this2 = this;

	        var xi = [x, y, 1];
	        if (d === this.calc(x, y)) {} else if (d < this.calc(x, y)) {
	...
	function test(data) {
	    ...
	    if (output[0] + output[1] === -2) {
	        if (data[0] > 0) output[0] = 1;else output[1] = 1;
	    }
