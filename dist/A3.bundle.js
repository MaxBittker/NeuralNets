	...
	*/
	...
	network.prototype = { //a function to call update on every node in a layer
	    calcHidden: function (input) {
	        ...
	        return [this.hiddenLayer[0].output([input[0], input[1]]), this.hiddenLayer[1].output([input[0], input[2]]), this.hiddenLayer[2].output([input[0], input[3]]), this.hiddenLayer[3].output([input[1], input[2]]), this.hiddenLayer[4].output([input[1], input[3]]), this.hiddenLayer[5].output([input[2], input[3]])
	    ...
	    train: function (data) {
	        ...
	        for (var o = 0; o < 3; o++) {
	            ...
	            this.hiddenLayer[0].learn([data[0], data[1]], desired[o], sum[0]), this.hiddenLayer[1].learn([data[2], data[3]], desired[o], sum[1]), this.hiddenLayer[0].learn([input[0], input[1]], desired[o], sum[2]), this.hiddenLayer[1].learn([input[0], input[2]], desired[o], sum[3]), this.hiddenLayer[2].learn([input[0], input[3]], desired[o], sum[4]), this.hiddenLayer[3].learn([input[1], input[2]], desired[o], sum[5]), this.hiddenLayer[4].learn([input[1], input[3]], desired[o], sum[6]), this.hiddenLayer[5].learn([input[2], input[3]], desired[o], sum[7]);
	        }
	    },
