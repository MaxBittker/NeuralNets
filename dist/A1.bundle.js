...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function network(x, y) {
	    ...
	    new perceptron(this.inputs, [2, 1], 8), new perceptron(this.inputs, [-2, 1], -8), new perceptron(this.inputs, [3, 1], 13), new perceptron(this.inputs, [-3, 1], -11)];
	...
	for (var y = 4.5; y > -.1; y -= .075) {
	    ...
	    for (var x = 0; x < 8; x += .075) {
	        ...
	        if (n0.output === 1) var chr = "&#9632;"; //unicode for black square
	...
	var ntest = new network(getJsonFromUrl().x, getJsonFromUrl().y);
	//code to write output to html
	document.write('<h1>Output at Point(' + getJsonFromUrl().x + ',' + getJsonFromUrl().y + ') is:' + ntest.output + '</h1>');
